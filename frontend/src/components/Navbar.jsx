...
import { LayoutDashboard, ChevronDown, User, LogOut, Users, ClipboardCheck } from 'lucide-react';
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              {['owner', 'marketing'].includes(user.role) && (
                <Link
                  to="/teams"
                  className="border-transparent text-slate-500 hover:border-primary hover:text-slate-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium gap-2"
                >
              ...
              {['owner', 'marketing', 'developer'].includes(user.role) && (
                <Link
                  to="/task-templates"
                  className="border-transparent text-slate-500 hover:border-primary hover:text-slate-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium gap-2"
                >
